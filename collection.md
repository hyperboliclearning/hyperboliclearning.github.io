...
[![Awesome](https://awesome.re/badge.svg)](https://github.com/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning) [![Stars](https://img.shields.io/github/stars/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning?color=yellow)](https://github.com/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning) [![Forks](https://img.shields.io/github/forks/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning?color=blue&label=Fork)](https://github.com/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning)
...
<div class="sticky-outline">
  <ul>
    ...
    <li><a href="#1-surveys-books-tools-tutorials">1. Surveys, Books, Tools, Tutorials</a>
      <ul class="subsection">
        <li><a href="#11-surveys">1.1 Surveys</a></li>
        <li><a href="#12-books">1.2 Books</a></li>
        <li><a href="#13-tools">1.3 Tools</a></li>
        <li><a href="#14-tutorials">1.4 Tutorials</a></li>
      </ul>
    </li>
    <li><a href="#2-core-methods-and-geometry">2. Core Methods and Geometry</a>
      <ul class="subsection">
        <li><a href="#21-hyperbolic-shallow-models-and-embeddings">2.1 Shallow Models and Embeddings</a></li>
        <li><a href="#22-hyperbolic-neural-networks">2.2 Hyperbolic Neural Networks</a></li>
        <li><a href="#23-hyperbolic-graph-neural-networks">2.3 Hyperbolic Graph Neural Networks</a></li>
        <li><a href="#24-attention-transformers-and-sequence-models">2.4 Attention, Transformers, and Sequence Models</a></li>
        <li><a href="#25-theory-analysis-and-numerical-stability">2.5 Theory, Analysis, and Numerical Stability</a></li>
        <li><a href="#26-hierarchy-and-tree-modeling">2.6 Hierarchy and Tree Modeling</a></li>
        <li><a href="#27-mixed-curvature-and-alternative-geometries">2.7 Mixed-Curvature and Alternative Geometries</a></li>
        <li><a href="#28-hyperbolic-generative-models">2.8 Hyperbolic Generative Models</a></li>
        <li><a href="#29-hyperbolic-classifiers-and-decision-models">2.9 Classifiers and Decision Models</a></li>
        <li><a href="#210-hyperbolic-operations-and-representation-utilities">2.10 Operations and Utilities</a></li>
        <li><a href="#211-llms-and-foundation-models">2.11 LLMs and Foundation Models</a></li>
      </ul>
    </li>
    <li><a href="#3-domain-applications">3. Domain Applications</a>
      <ul class="subsection">
        <li><a href="#31-language-and-text-applications">3.1 Language and Text</a></li>
        <li><a href="#32-computer-vision-graphics-and-robotics">3.2 Computer Vision, Graphics, and Robotics</a></li>
        <li><a href="#33-graphs-and-networked-data">3.3 Graphs and Networked Data</a></li>
        <li><a href="#34-recommender-systems">3.4 Recommender Systems</a></li>
        <li><a href="#35-knowledge-graphs">3.5 Knowledge Graphs</a></li>
        <li><a href="#36-biology-and-molecular-learning">3.6 Biology and Molecular Learning</a></li>
        <li><a href="#37-code-representation">3.7 Code Representation</a></li>
      </ul>
    </li>
    <li><a href="#4-task-oriented-settings">4. Task-Oriented Settings</a>
      <ul class="subsection">
        <li><a href="#41-multi-label-and-hierarchical-classification">4.1 Multi-label & Hierarchical Classification</a></li>
        <li><a href="#42-metric-learning-retrieval-and-clustering">4.2 Metric Learning, Retrieval, Clustering</a></li>
        <li><a href="#43-data-driven-geometry-learning-and-adaptation">4.3 Data-Driven Geometry Learning</a></li>
        <li><a href="#44-few-shot-and-low-data-learning">4.4 Few-Shot & Low-Data Learning</a></li>
        <li><a href="#45-open-vocabulary-zero-shot-and-category-discovery">4.5 Open-Vocab & Zero-Shot</a></li>
        <li><a href="#46-safety-robustness-and-privacy">4.6 Safety, Robustness, Privacy</a></li>
        <li><a href="#47-environmental-monitoring">4.7 Environmental Monitoring</a></li>
        <li><a href="#48-multi-criteria-learning">4.8 Multi-Criteria Learning</a></li>
      </ul>
    </li>
  </ul>
</div>
...
<style>
/* ---- Homepage-style heading treatment ---- */
.page-content h1 {
  text-align: center;
  margin-top: 0.2em;
  margin-bottom: 0.9em;
...
/* Body links use slate blue, terracotta on hover */
.page-content p a,
.page-content li a {
  color: var(--primary, #3a5a7c);
...
/* ---- Slack-group block uses card style matching home page ---- */
.group-card {
...
.group-card ul { list-style: none; padding-left: 0; margin: 0; }
.group-card li {
  display: flex;
  align-items: center;
  gap: 0.5em;
...
/* ---- Citation block (matches home page) ---- */
.cite-block {
  background: var(--bg, #f7f5f2);
  border: 1px solid var(--border, #e5e2dd);
  border-left: 3px solid var(--primary, #3a5a7c);
...
/* ---- Sticky outline (matches home page palette) ---- */
.sticky-outline {
  position: fixed;
  top: 80px;
  left: 20px;
...
### 2.1 Hyperbolic Shallow Models and Embeddings
...
### 2.4 Attention, Transformers, and Sequence Models
...
### 2.5 Theory, Analysis, and Numerical Stability
...
### 2.6 Hierarchy and Tree Modeling
...
### 2.7 Mixed-Curvature and Alternative Geometries
...
### 2.8 Hyperbolic Generative Models
...
### 2.9 Hyperbolic Classifiers and Decision Models
...
### 2.10 Hyperbolic Operations and Representation Utilities
...
### 3.1 Language and Text Applications
...
### 3.2 Computer Vision, Graphics, and Robotics
...
### 3.6 Biology and Molecular Learning
...
### 4.1 Multi-label and Hierarchical Classification
...
### 4.2 Metric Learning, Retrieval, and Clustering
...
### 4.3 Data-Driven Geometry Learning and Adaptation
...
### 4.4 Few-Shot and Low-Data Learning
...
### 4.5 Open-Vocabulary, Zero-Shot, and Category Discovery
...
### 4.6 Safety, Robustness, and Privacy
...
<div class="cite-block">
  ...
  <pre id="bib-text">@misc{hyperbolic-repo,
  author       = {Menglin Yang, Min Zhou, Rex Ying},
  title        = {Hyperbolic Representation and Deep Learning:
...
// Wrap the page title in a link to the upstream GitHub repo
(function () {
  var t = document.querySelector('.post-title');
  if (!t) return;
  var txt = t.textContent;
  t.innerHTML = '<a href="https://github.com/marlin-codes/Awesome-Hyperbolic-Representation-and-Deep-Learning" class="title-link" target="_blank" rel="noopener">' + txt + '</a>';
})();
</script>

<style>
.post-title {
  color: var(--primary, #3a5a7c) !important;
...
.post-title .title-link:hover {
  color: var(--primary-light, #4d7a9e);
  border-bottom-color: var(--primary, #3a5a7c);
}
</style>
